...
const uint8_t attMcsSvcUuid[ATT_16_UUID_LEN] = { ATT_UUID_MCS_SERVICE };

/*Characteristic variables declaration*/
const uint8_t svcMcsButtonUuid[ATT_128_UUID_LEN] = { ATT_UUID_CURRENT_TIME_CHAR };
...
static const uint8_t mcsButtonValCh[] = { ATT_PROP_READ | ATT_PROP_NOTIFY,
                                          UINT16_TO_BYTES(MCS_BUTTON_HDL), ATT_UUID_CURRENT_TIME_CHAR };
